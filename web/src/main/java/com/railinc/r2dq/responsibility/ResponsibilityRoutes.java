...
public class ResponsibilityRoutes extends Routes {
	private static final String PREFIX = "responsibility";

	public static final String ROOT_PATH = "/s/admin/responsibility";
