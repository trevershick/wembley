...
<title><fmt:message key="implementation.title.edit" /></title>
<meta name="where" content="admin.implementation.edit" />
...
<fieldset>
    <legend><fmt:message key="implementation.title.edit" /></legend>
