...
public class UserGroupRoutes extends Routes {
	private static final String PREFIX = "usergroup";

	public static final String ROOT_PATH = "/s/admin/usergroup";
