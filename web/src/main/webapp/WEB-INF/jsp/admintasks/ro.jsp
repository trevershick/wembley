	...
	<div id="content">
		...
		<form:form method="POST" commandName="taskform" cssClass="form form-horizontal">
											...
											<div class="remediation-actions pull-right span6">
												...
												<c:if test="${r.canApprove }">
													<label class="radio text-success">
													  <form:radiobutton path="exceptions[${s.index }].action" value="approve" disabled="true"/>
													  <c:set var="def">
												...
												<label class="radio text-error">
												  <form:radiobutton path="exceptions[${s.index }].action" value="disapprove" disabled="true"/>
													  	<c:set var="def">
												...
												<label class="radio text-warning">
												  <form:radiobutton path="exceptions[${s.index }].action" value="ignore" disabled="true"/>
													  	<c:set var="def">
												...
												<div class="controls">
													<form:input path="exceptions[${s.index }].userComment" cssClass="input-xlarge"  disabled="true"/>
												</div>
			...
			<div class="form-actions">
			    ...
			    <input type="submit" class="btn btn-close btn-inverse" value="Close" name="_close"/>
			    </div>
		    </div>
		</form:form>
	</div>
